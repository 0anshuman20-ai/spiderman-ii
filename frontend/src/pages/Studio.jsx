...
export default function Studio() {
  ...
  const captionsRef = useRef(false);   // mirrored into the frame callback — OFF: YouTube auto-generates captions on upload
  ...
  const [captionsOn, setCaptionsOn] = useState(false); // default OFF: captions are generated by YouTube directly on upload
  // sound layer UI
